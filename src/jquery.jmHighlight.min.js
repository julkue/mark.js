...
h=!0);0==h&&a.replaceWith(a.text());return!0};d.fn.jmHighlight=function(a,b){return(new c(d(this),a,b)).highlight()};d.fn.jmRemoveHighlight=function(a,b){return(new c(d(this),b,a)).removeHighlight()}});
