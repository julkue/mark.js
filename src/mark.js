    ...
    createDiacriticsRegExp(str) {
        const sens = this.opt.caseSensitive ? "" : "i",
            dct = this.opt.caseSensitive ? [
                ...
                "aAÀÁÂÃÄÅàáâãäåĀāąĄăĂ", "cCÇçćĆčČ", "dDđĐďĎ",
                "eEÈÉÊËèéêëěĚĒēęĘ", "iIÌÍÎÏìíîïĪī", "lLłŁ", "nNÑñňŇńŃ",
                "oOÒÓÔÕÖØòóôõöøŌō", "rRřŘ", "sSŠšśŚșȘşŞ", "tTťŤțȚţŢ",
                "uUÙÚÛÜùúûüůŮŪū", "yYŸÿýÝ", "zZŽžżŻźŹ"
            ];
        let handled = [];
